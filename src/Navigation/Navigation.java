...
public class Navigation {
    ...
    public static Navigation naviLager = new Navigation("Lager",new ImageIcon("res/Icons/Reddit.png"));
    public static Navigation naviKampf = new Navigation("Kampf",new ImageIcon("res/Icons/Battle.png"));
    public static Navigation naviEvent = new Navigation("Event",new ImageIcon("res/Icons/Instagram_2.png"));
